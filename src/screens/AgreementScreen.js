...
export const AgreementScreen = ({navigation}) => {
    return (
        <ScrollView style={styles.container}>
            <View style={{marginBottom: 35}}>
                <AppTextBold style={styles.title}>Heading</AppTextBold>
                ...
                <AppButton onPress={() => navigation.navigate('Profile')} bgColor={THEME.MAIN_COLOR}>Valmis</AppButton>
            </View>
        </ScrollView>
    )
}
